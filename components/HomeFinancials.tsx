    ...
    return (
        <div className="relative p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            <Link
                ...
                className="absolute top-4 right-4 inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-teal-600 rounded-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 transition duration-150 ease-in-out"
            >
                전체 목록
            </Link>
