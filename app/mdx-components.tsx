...
export function useMDXComponents(): MDXComponents {
    return {
        h1: (props) => {
            return <h1 className={cn("text-6xl font-bold my-8 scroll-margin-top-16 dark:text-white", props.className)} {...props} />;
        },
        h2: (props) => {
            return <h2 className={cn("text-4xl font-bold my-8 scroll-mt-16 dark:text-white", props.className)} {...props} />;
        },
        p: ({ children }) => (
